  ...
  handleClick(i) {
    ...
    */
    if (
      ...
      !clueSubmitted ||
      !playerView ||
      calculateWinner(blueSquares, redSquares, selected, blueTurn, deathSquare)
    ) {
      return;
    }
        ...
        if (!clueSubmitted) {
              ...
              <div>
                ...
                <form onSubmit={this.onClueSubmit}>
                  ...
                  <Input
                    ...
                    fluid={true}
                    value={this.state.clueNumInput}
                    onChange={this.updateInputClueNum}
                  />
          ...
          formOrClue = (
            <Grid.Column textAlign="center">
              <h2>Clue</h2>
              <Message className="clue" color={color} header={header} />
            </Grid.Column>
          );
        }
      }
          ...
          <Container>
            ...
            <Grid className="gameInfo" verticalAlign={'top'} centered={true}>
              <Grid.Row columns={3} verticalAlign={'top'} style={{ marginBottom: '2px' }}>
                ...
                <Grid.Column textAlign="center">{formOrClue}</Grid.Column>
